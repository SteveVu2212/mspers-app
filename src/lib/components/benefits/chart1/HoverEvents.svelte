<script>
	...
	const dates = data1[selectedKey1].map((d) => d.x);
	...
	let getYValue1 = (date) => data1[selectedKey1].filter((d) => d.x >= date)[0]?.y;
	let getYValue2 = (date) => data2[selectedKey2].filter((d) => d.x >= date)[0]?.y;
	let getYValue3 = (date) => data3[selectedKey3].filter((d) => d.x >= date)[0]?.y;
	let getYValue4 = (date) => data4[selectedKey4].filter((d) => d.x >= date)[0]?.y;
